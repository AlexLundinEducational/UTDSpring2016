...
int main()
{
	...
	ptr = arrayExpander(array1, sizeOfArray);												// function call, return value to ptr
	cout << "The address of the array created in arrayExpander function was " << endl;		// output
	cout << ptr << endl;
...
int *arrayExpander(int array1[10], int sizeOfArray)
{
	int array2[20];
	int counterMax = 10;
	int counter2Max = 20;
	...
	{
		if (counter < counterMax)															// if we are still in bounds for array 1
		{
